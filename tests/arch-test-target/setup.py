...
def setup_testlist(riscv_device, hw_data_misalign):
    ...
    file['hart0']['ISA'] = ISA
    file['hart0']['hw_data_misaligned_support'] = True if hw_data_misalign == "1" else False
...
if __name__=="__main__":
    ...
    parser.add_argument('--hw_data_misalign', help='whether accept hardware data misalgnment or not',
                        default='1')
    args = parser.parse_args()

    setup_testlist(args.riscv_device, args.hw_data_misalign)
    setup_config()
